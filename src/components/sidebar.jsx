        ...
        <div>
          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            <div className="text-center">
              ...
              <h1 id="colorlib-logo"><a href="index.html">Lankesh De Silva</a></h1>
              <span className="email"><i className="icon-mail"></i> lankeshdesilva16@gmail.com</span>
            </div>
            ...
            <nav id="colorlib-main-menu">
              <ul>
                ...
                <li><a href="https://github.com/lankesh16" target="_blank" rel="noopener noreferrer"><i className="icon-github"></i></a></li>
